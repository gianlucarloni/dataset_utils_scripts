...
# mean = np.load(os.path.join(input_dir,'mean.npy')) #TODO
...
np.save(os.path.join(input_dir,'list_H.npy'),list_H)
np.save(os.path.join(input_dir,'list_W.npy'),list_W)
np.save(os.path.join(input_dir,'list_maxSize.npy'),imgsize_list)
